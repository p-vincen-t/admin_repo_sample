...
const Header = props => {
  ...
  const [sidebar] = useSelector(({ layout: { sidebar } }) => [sidebar]);
    ...
    <Fragment>
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar className={classes.toolbar}>
          ...
          <Typography component="h1" color="inherit" className={classes.title} variant="h6" noWrap>
            Nesst
          </Typography>
